...
class Ticket(models.Model):
    ...
    empresa = models.CharField(max_length=254, default='Nombre de la empresa')

    address = models.CharField(max_length=150, default='')

    companyIdentifier = models.CharField(max_length=254, default='')

    identifier = models.CharField(unique=True,
                                  max_length=254, default='autogenerateduniqueid-custom')
